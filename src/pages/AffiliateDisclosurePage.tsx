  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-8">
      ...
      <div className="p-6 md:p-8 rounded-3xl bg-white border border-[#E9E1D2] space-y-6 text-sm md:text-base text-[#474038] leading-relaxed">
        ...
        <h2 className="font-serif font-bold text-xl text-[#242220] pt-2">
          4. Google AdSense & Display Advertising
        </h2>
        <p>
          In addition to affiliate travel links, our website may display automated third-party advertisements via Google AdSense. 
          These advertisements are clearly labeled as "Advertisements" or "Sponsored" and are generated by automated algorithms based on contextual and behavioral signals. 
          Travel Hideouts does not personally select or endorse the specific third-party products advertised in these automated units. You can control your ad personalization settings at any time by visiting <a href="https://adssettings.google.com/" target="_blank" rel="noopener noreferrer" className="text-[#8C6D58] underline">Google Ads Settings</a> or adjusting your choices in our <a href="/privacy-policy/" className="text-[#8C6D58] underline">Privacy Policy</a>.
        </p>
